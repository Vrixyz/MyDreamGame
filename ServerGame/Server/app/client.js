...
var Human = require('../shared/Human');
...
L.tileLayer('https://{s}.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}', {
  ...
  id: 'vrixyz.8c2bc939',
  accessToken: "pk.eyJ1IjoidnJpeHl6IiwiYSI6Ijc4MGU3NzY5MDE2YmIwNzlkMDUwYjc2MzIyNDhiZGRiIn0.2qEbFDFdys0dgN0MM5KWNQ#4"
}).addTo(map);
// https://a.tiles.mapbox.com/v4/vrixyz.8c2bc939/page.html?access_token=
// pk.eyJ1IjoidnJpeHl6IiwiYSI6Ijc4MGU3NzY5MDE2YmIwNzlkMDUwYjc2MzIyNDhiZGRiIn0.2qEbFDFdys0dgN0MM5KWNQ#4/48.87/2.33
var popup = L.popup();
